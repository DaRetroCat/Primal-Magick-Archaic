...
public class SpellcraftingAltarScreen extends ContainerScreen<SpellcraftingAltarContainer> {
    ...
    protected void initWidgets() {
        ...
        this.texts.put(new Vector3i(x, y + 2, 106), new TranslationTextComponent("primalmagick.spell.vehicle.header"));
        ...
        y = startY + 48;
        this.texts.put(new Vector3i(x, y + 2, 106), new TranslationTextComponent("primalmagick.spell.payload.header"));
        ...
        x += 110;
        y = startY;
        this.texts.put(new Vector3i(x, y + 2, 106), new TranslationTextComponent("primalmagick.spell.primary_mod.header"));
        ...
        y = startY + 48;
        this.texts.put(new Vector3i(x, y + 2, 106), new TranslationTextComponent("primalmagick.spell.secondary_mod.header"));
