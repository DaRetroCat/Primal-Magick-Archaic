...
public class RitualBellBlock extends Block implements IRitualPropBlock {
    ...
    protected static final VoxelShape FLOOR_SHAPE = VoxelShapes.or(BELL_CORE_SHAPE, VoxelShapeUtils.fromModel(new ResourceLocation(PrimalMagick.MODID, "block/ritual_bell_floor")));
    protected static final VoxelShape CEILING_SHAPE = VoxelShapes.or(BELL_CORE_SHAPE, VoxelShapeUtils.fromModel(new ResourceLocation(PrimalMagick.MODID, "block/ritual_bell_ceiling")));
    protected static final VoxelShape ONE_WALL_SHAPE = VoxelShapes.or(BELL_CORE_SHAPE, VoxelShapeUtils.fromModel(new ResourceLocation(PrimalMagick.MODID, "block/ritual_bell_wall")));
    protected static final VoxelShape TWO_WALLS_SHAPE = VoxelShapes.or(BELL_CORE_SHAPE, VoxelShapeUtils.fromModel(new ResourceLocation(PrimalMagick.MODID, "block/ritual_bell_between_walls")));
