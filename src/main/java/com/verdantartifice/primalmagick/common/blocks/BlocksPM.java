...
import com.verdantartifice.primalmagick.common.blocks.misc.PyramidBlock;
...
public class BlocksPM {
    ...
    // Register mana fonts
    public static final RegistryObject<AncientManaFontBlock> ANCIENT_FONT_EARTH = BLOCKS.register("ancient_font_earth", () -> new AncientManaFontBlock(Source.EARTH, Block.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; }).noDrops()));
    public static final RegistryObject<AncientManaFontBlock> ANCIENT_FONT_SEA = BLOCKS.register("ancient_font_sea", () -> new AncientManaFontBlock(Source.SEA, Block.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; }).noDrops()));
    public static final RegistryObject<AncientManaFontBlock> ANCIENT_FONT_SKY = BLOCKS.register("ancient_font_sky", () -> new AncientManaFontBlock(Source.SKY, Block.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; }).noDrops()));
    public static final RegistryObject<AncientManaFontBlock> ANCIENT_FONT_SUN = BLOCKS.register("ancient_font_sun", () -> new AncientManaFontBlock(Source.SUN, Block.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; }).noDrops()));
    public static final RegistryObject<AncientManaFontBlock> ANCIENT_FONT_MOON = BLOCKS.register("ancient_font_moon", () -> new AncientManaFontBlock(Source.MOON, Block.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; }).noDrops()));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_EARTH = BLOCKS.register("artificial_font_earth", () -> new ArtificialManaFontBlock(Source.EARTH, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_SEA = BLOCKS.register("artificial_font_sea", () -> new ArtificialManaFontBlock(Source.SEA, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_SKY = BLOCKS.register("artificial_font_sky", () -> new ArtificialManaFontBlock(Source.SKY, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_SUN = BLOCKS.register("artificial_font_sun", () -> new ArtificialManaFontBlock(Source.SUN, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_MOON = BLOCKS.register("artificial_font_moon", () -> new ArtificialManaFontBlock(Source.MOON, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_BLOOD = BLOCKS.register("artificial_font_blood", () -> new ArtificialManaFontBlock(Source.BLOOD, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_INFERNAL = BLOCKS.register("artificial_font_infernal", () -> new ArtificialManaFontBlock(Source.INFERNAL, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_VOID = BLOCKS.register("artificial_font_void", () -> new ArtificialManaFontBlock(Source.VOID, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> ARTIFICIAL_FONT_HALLOWED = BLOCKS.register("artificial_font_hallowed", () -> new ArtificialManaFontBlock(Source.HALLOWED, DeviceTier.ENCHANTED, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    ...
    public static final RegistryObject<ArtificialManaFontBlock> FORBIDDEN_FONT_SEA = BLOCKS.register("forbidden_font_sea", () -> new ArtificialManaFontBlock(Source.SEA, DeviceTier.FORBIDDEN, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> FORBIDDEN_FONT_SKY = BLOCKS.register("forbidden_font_sky", () -> new ArtificialManaFontBlock(Source.SKY, DeviceTier.FORBIDDEN, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> FORBIDDEN_FONT_SUN = BLOCKS.register("forbidden_font_sun", () -> new ArtificialManaFontBlock(Source.SUN, DeviceTier.FORBIDDEN, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> FORBIDDEN_FONT_MOON = BLOCKS.register("forbidden_font_moon", () -> new ArtificialManaFontBlock(Source.MOON, DeviceTier.FORBIDDEN, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    ...
    public static final RegistryObject<ArtificialManaFontBlock> FORBIDDEN_FONT_VOID = BLOCKS.register("forbidden_font_void", () -> new ArtificialManaFontBlock(Source.VOID, DeviceTier.FORBIDDEN, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    ...
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_EARTH = BLOCKS.register("heavenly_font_earth", () -> new ArtificialManaFontBlock(Source.EARTH, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_SEA = BLOCKS.register("heavenly_font_sea", () -> new ArtificialManaFontBlock(Source.SEA, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_SKY = BLOCKS.register("heavenly_font_sky", () -> new ArtificialManaFontBlock(Source.SKY, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_SUN = BLOCKS.register("heavenly_font_sun", () -> new ArtificialManaFontBlock(Source.SUN, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_MOON = BLOCKS.register("heavenly_font_moon", () -> new ArtificialManaFontBlock(Source.MOON, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
    public static final RegistryObject<ArtificialManaFontBlock> HEAVENLY_FONT_BLOOD = BLOCKS.register("heavenly_font_blood", () -> new ArtificialManaFontBlock(Source.BLOOD, DeviceTier.HEAVENLY, Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 12.0F).sound(SoundType.STONE).setLightLevel((state) -> { return 15; })));
