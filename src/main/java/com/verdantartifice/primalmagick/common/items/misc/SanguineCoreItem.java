...
public class SanguineCoreItem extends Item {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("tooltip.primalmagick.sanguine_core.1", this.getMaxDamage(stack) - this.getDamage(stack) + 1));
        tooltip.add(new TranslationTextComponent("tooltip.primalmagick.sanguine_core.2", this.soulsPerSpawn));
    }
