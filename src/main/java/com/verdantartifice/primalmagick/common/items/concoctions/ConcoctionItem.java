...
public class ConcoctionItem extends Item {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("concoctions.primalmagick.doses_remaining", ConcoctionUtils.getCurrentDoses(stack)).mergeStyle(EffectType.BENEFICIAL.getColor()));
    }
