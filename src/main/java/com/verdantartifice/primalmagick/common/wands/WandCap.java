...
public class WandCap implements IWandComponent {
    ...
    public WandCap(@Nonnull String tag, @Nonnull Rarity rarity, double costModifier) {
        this(tag, rarity, costModifier, new ModelResourceLocation(new ResourceLocation(PrimalMagick.MODID, tag + "_wand_cap"), ""), new ModelResourceLocation(new ResourceLocation(PrimalMagick.MODID, tag + "_staff_cap"), ""));
    }
